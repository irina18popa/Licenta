...
def control_tv(command):
    try:
        ...
        #tv.shortcuts().power()
            ...
            # Power On
        #wakeonlan.send_magic_packet("44:5C:E9:8E:AB:75")


        
        # Map commands to TV key codes.
        if command == "power_on" or command == "power_off":
            # Many Samsung TVs use the same key to toggle power.
            tv.send_key("KEY_POWER")
            print("Sent KEY_POWER command to TV")
            ...
            tv.send_key("KEY_UNMUTE")
            print("Sent KEY_UNMUTE command")
        elif command == "channel_up":
            tv.send_key("KEY_CHUP")
            print("Sent KEY_CHUP command")
        elif command == "channel_down":
...
control_tv("power_on")  # Example: Turn the TV on
#control_tv("volume_up")  # Example: Increase volume
