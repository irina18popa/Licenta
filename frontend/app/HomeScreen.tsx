...
const HomeScreen = () => {
  ...
  const renderDevice = ({ item }) => (
    <TouchableOpacity className="flex-row justify-between items-center bg-black bg-opacity-50 mx-5 my-2 rounded-xl p-4">
  ...
  return (
    <SafeAreaView className="flex-1 bg-white-100">
      ...
      {/* Search */}
      <View className="flex-row bg-white mx-5 my-5 rounded-lg p-3 items-center">
      ...
      {/* Tabs */}
      <View className="flex-row bg-white mx-5 rounded-lg p-1 mt-5">
        <TouchableOpacity
